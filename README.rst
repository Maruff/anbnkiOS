...
A `Raspberry Pi <http://www.raspberrypi.org/>`_ and other ARM devices distribution builder. anbnkiOS opens an already existing image, modifies it and repackages the image ready to ship.
...
Donate
------
anbnkiOS is 100% free and open source and maintained by Guy Sheffer. If its helping your life, your organisation or makes you happy, please consider making a donation. It means I can code more and worry less about my balance. Any amount counts.
...
`Clone this repo <https://github.com/Maruff/anbnkiOS>`_. Then follow instructions either to build an existing distro or create your own.
...
#. Clone this image ``git clone https://github.com/Maruff/anbnkiOS.git``
...
3. OS X -  `See this thread for information <https://github.com/Maruff/OctoPi/issues/388#issuecomment-316327106>`_
...
anbnkiOS comes with a script ``common.sh`` that has useful functions you can use inside your chroot_script.
...
Build using CI/CD
~~~~~~~~~~~~~~~~~
You can build anbnkiOS images from a continuous integration system in the cloud.
For an example on how to do this on github take a look at `this github actions yaml <https://github.com/Maruff/OctoPi/blob/devel/.github/workflows/build.yml/>`_
...
List of Distributions using anbnkiOS
--------------------------------------
...
* `FullPageOS <https://github.com/Maruff/FullPageOS>`_ - A Raspberry Pi distro to display a full page browser on boot
* `Zynthian <http://zynthian.org/>`_ - Open Synth Platform
* `ElectricSheepPi <https://github.com/Maruff/ElectricSheepPi>`_ - A Raspberry Pi distribution to run Electric Sheep digital art
* `AlarmPi <https://github.com/Maruff/AlarmPi>`_ - A Raspberry Pi distribution that turns a Raspberry Pi to an IOT telegram-controlled alarm clock
* `RealtimePi <https://github.com/Maruff/RealtimePi>`_ - An out-of-the-box Raspebrry Pi/Raspbian distro with a realtime kernel
...
* `HotSpotOS <https://github.com/Maruff/HostSpotOS>`_ - Makes a Raspberry Pi start a hotspot, if no wifi was found to connect to
* `MtigOS <https://github.com/Maruff/MtigOS>`_ - Distro that lets you receive, store and graph sensor information from ESP8266 chips. It uses and MTIG stack: Mosquitto, Telegraf, InfluxDB and Grafana which are all pre-configured to work together. They automatically update using Docker.
...
* `UbuntuDockerPi <https://github.com/Maruff/UbuntuDockerPi>`_ - Distro ships with Ubuntu ARM 64bit Docker and docker-compose ready to build stuff for arm64v8/aarch64 or host whatever you like.
